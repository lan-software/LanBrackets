...
const bgColor = urlParams.get('bg') === 'transparent' ? 'rgba(0,0,0,0)' : undefined
...
<template>
    <div class="h-screen w-screen overflow-hidden" :style="bgColor === 'rgba(0,0,0,0)' ? 'background: transparent' : 'background: #0f172a'">
